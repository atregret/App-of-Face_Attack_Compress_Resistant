        ...
        <div id="main">
            <div class="well">
              <div class="row">
                ...
                <div class="col-sm-4">
                  <button type="button" class="btn btn-primary" @click="beginTest">开始测试</button>
...
data(){
    ...
    methods:{
      ...
      sendimg($event,a){
        ...
        //在当前作用域中,变动会"生效",但是函数结束后,data中的值并没有改变
        //如果用户取消上传操作,则直接退出
        ...
        console.log("22")
        //清空用户名和匹配分数
        // this.$set(this,'user_name1','')
        // Vue.set(this,'user_name2','')
        // Vue.set(this,'user_name3','')
        // Vue.set(this,'score1','')
        // Vue.set(this,'score2','')
        // Vue.set(this,'score3','')
        // Vue.set(this,'ok',false)
        // console.log(this.user_name1)
        setTimeout(function(){
